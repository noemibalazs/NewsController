...
class PoliticsFragment : BaseFragment() {

    override val viewModel: PoliticsViewModel by viewModel()
    ...
    override fun setUpObservables(lifecycleOwner: LifecycleOwner) {
        viewModel.getPolitics().observe(lifecycleOwner, Observer {
    ...
    private fun initSearchHint(){
        searchNews.hint = getString(R.string.search_hint_politics)
    }
