...
class PoliticsRepository(val newsSource: NewsSource) {

    suspend fun getPoliticsNews(search:String): Either<Failure, NewsBody>{
        return newsSource.getPoliticsNews(KEY, search, ORDER_BY_POLITICS)
    }
}